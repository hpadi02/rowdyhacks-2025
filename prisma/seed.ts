  ...
  const users = await Promise.all([
    ...
    prisma.user.create({
      data: {
        ...
        locale: 'ES',
        interests: ['Business', 'Healthcare', 'Community'],
        verified: true,
        rating: 5.0,
      },
    }),
  ...
  const posts = await Promise.all([
    prisma.post.create({
      data: {
        ...
        category: 'MEDICAL',
        images: ['https://via.placeholder.com/400x300/FF6B6B/FFFFFF?text=Medical+Need'],
        links: [],
    ...
    prisma.post.create({
      data: {
        ...
        category: 'OTHER',
        images: ['https://via.placeholder.com/400x300/4ECDC4/FFFFFF?text=Business+Growth'],
    ...
    prisma.post.create({
      data: {
        ...
        images: ['https://via.placeholder.com/400x300/45B7D1/FFFFFF?text=Community+Garden'],
        links: [],
  ...
  const circles = await Promise.all([
    prisma.circle.create({
      data: {
        ...
        members: [users[0].id, users[1].id], // Carmen and Sam are members
      },
    }),
  ]);
